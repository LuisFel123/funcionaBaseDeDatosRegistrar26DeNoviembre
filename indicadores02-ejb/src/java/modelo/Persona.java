...
@NamedQueries({
    ...
    @NamedQuery(name = "Persona.findByCadera", query = "SELECT p FROM Persona p WHERE p.cadera = :cadera"),
...
public class Persona implements Serializable {
    ...
    public Persona(Integer idPersona, String usuario, String password) {
        this.idPersona = idPersona;
